import { getSecret } from "@/postgres-meta/secrets";
...
export const PG_CONNECTION =
  process.env.PG_META_DB_URL || `postgres://${PG_META_DB_USER}:${encodeURIComponent(PG_META_DB_PASSWORD)}@${PG_META_DB_HOST}:${PG_META_DB_PORT}/${PG_META_DB_NAME}?sslmode=${PG_META_DB_SSL_MODE}`;
