...
export const labExamples: FilesItemType[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { type: 'file', key: '3f22e866-6b5b-433b-b3d6-42bf9fc41319', label: '.env', data: { dataType: 'env', code: 'PUBLISHER_NAME=ESP32', language: 'env' } },
      {
        type: 'file',
