        ...
        <Draggable handle=".draggable-handle">
          <Box>
            <ModalContent borderRadius={'14px'} overflow="hidden">
              {formModal.title && (
                <>
                  <ModalHeader bg="#F8F8FA"  px="1.5rem" fontSize={'1.2rem'} py="1rem" fontWeight={600} cursor="move" className="draggable-handle">
                    {formModal.title}
                    <ModalCloseButton mt=".25rem" mr="0.5rem" color={'#7A7A7A'} fontSize={'1rem'} />
                  </ModalHeader>
